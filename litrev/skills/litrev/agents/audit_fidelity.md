...
- `claims_audit.json` — automated claim verification results (VERIFIED / LABEL_UNCERTAIN / UNVERIFIED / NO_ABSTRACT / NO_EXTRACTION; multi_citation flag on ambiguous claims)
...
For each claim marked LABEL_UNCERTAIN, UNVERIFIED, or NO_ABSTRACT in `claims_audit.json`:
...
- Automated audit: X VERIFIED, W LABEL_UNCERTAIN, Y NO_ABSTRACT, Z UNVERIFIED
